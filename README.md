...
<br>Form for the creation of a custom POKEMON:<br>
...
<br><br>
If you´d like to run this project on your computer you´d need to create a DB with posgresSQl named pokemon.
You´d also need to download the zip of this repository and create an .env file inside the "api" folder with the following information:<br>
